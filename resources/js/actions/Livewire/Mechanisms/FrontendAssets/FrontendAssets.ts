 ...
 * @route '/livewire-d4ab9da2/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-d4ab9da2/livewire.js',
 ...
 * @route '/livewire-d4ab9da2/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-d4ab9da2/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-d4ab9da2/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-d4ab9da2/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
