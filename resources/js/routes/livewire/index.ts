 ...
 * @route '/livewire-d4ab9da2/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-d4ab9da2/upload-file',
 ...
 * @route '/livewire-d4ab9da2/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-d4ab9da2/preview-file/{filename}',
