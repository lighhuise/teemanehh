import { c as cn, o as buttonVariants, s as Wrapper, t as AppLayout } from "./app-layout-DUdzOxuv.js";
...
function Hero() {
	return /* @__PURE__ */ jsx("div", {
		className: `bg-primary px-6 pt-28 pb-14 -mt-24 relative z-0`,
		children: /* @__PURE__ */ jsx(CutoutBox, {
			asWrapper: true,
			position: "both",
			className: "bg-background w-full min-h-122 rounded-md p-6 grid place-content-center",
			children: /* @__PURE__ */ jsx("h1", {
				className: "text-7xl max-w-2xl mx-auto text-center font-black tracking-tight",
...
//# sourceMappingURL=home-on2bm_3B.js.map