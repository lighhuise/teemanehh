...
function Navigation$1() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
		className: "bg-linear-to-t from-primary/70 to-primary border-b-2 relative  bordr-primary z-100 mb-4  text-white text-[8px]  font-bold py-2.5 px-4 tracking-[0.2em] uppercase hidden sm:block",
		...
		children: /* @__PURE__ */ jsxs(Wrapper, {
			className: "flex h-20 items-center justify-between bg-background border border-border shadow-xs rounded-md",
			children: [
				/* @__PURE__ */ jsx(Link, {
					href: "/",
					prefetch: "hover",
...
var Map = lazy(() => import("./map-DCapyeB_.js"));
function AppLayout({ children, title, description, image }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen bg-background text-foreground transition-colors duration-300 selection:bg-primary/75 selection:text-white",
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				className: ` w-full min-h-180 absolute opacity-50 -z-10 top-0 inset-x-0 bg-linear-to-b from-primary/25 to-background dark:from-black     pointer-events-none `,
				"aria-hidden": true
			}),
...
//# sourceMappingURL=app-layout-C6YHPn1x.js.map