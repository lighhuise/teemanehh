...
**Subheading:** CRANE HIRE • HEAVY LIFTING • SPECIALISED TRANSPORT
**Image:** `hero-background.webp`

**Stat 1 Label:** Years of Experience
**Stat 1 Value:** 25+
**Stat 2 Label:** Successful Projects
**Stat 2 Value:** 500+
**Stat 3 Label:** Availability
**Stat 3 Value:** 24/7

---

## Block 2: Intro (Who We Are)

**Label:** Who We Are
**Heading:** THE ONLY NAME TRUSTED TO PERFORM
**Image:** `IMG_0190-copy.webp`
**Stat Card Value:** 100+
...
## Block 3: Services Section (Dynamic)

*(Note: The services displayed here are pulled directly from the CMS Services page. You can edit individual services in the `services/` folder.)*
...
## Block 4: Safety Section

**Label:** Where Excellence Begins
**Heading:** SAFETY STARTS BEFORE THE LIFT
**Image:** `media-24-building.webp`
**Stat Card Value:** 500+
...
**Button 1 Label:** Start a Project
**Button 1 URL:** /contact-us
**Button 2 Label:** Our Approach
**Button 2 URL:** /about-us

---

## Block 5: Credentials & Associations

**Heading:** CREDENTIALS
**Label:** Qualifications

*(Note: Add/Update partner and qualification logos in this section's image folder)*
